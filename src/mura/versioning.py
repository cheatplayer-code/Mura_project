...
CURRENT_PIPELINE_VERSIONS = PipelineVersions(
    ...
    evaluator="core-evaluator-v6-asr-contract",
    benchmark_schema="benchmark-v6-asr-contract+identity-safety+entity-resolution-benchmark-v2",
